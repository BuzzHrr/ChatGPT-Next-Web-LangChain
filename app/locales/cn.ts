...
const cn = {
  ...
  Error: {
    Unauthorized: isApp
      ...
      : "由于访问量增加，为防止API盗刷，本站增设密码，目前您的访问密码不正确或为空，请前往[登录](/#/auth)页输入正确的访问密码，或者在[设置](/#/settings)页填入你自己的 OpenAI API Key。\n获取密码请🐧[联系BUZZ](https://qm.qq.com/q/wpLvAH87cc)！！",
  },
  Auth: {
    Title: "需要密码",
